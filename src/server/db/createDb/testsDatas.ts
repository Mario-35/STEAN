...
const wattEco = process.env.NODE_ENV === "test" ? require("../../../../sandbox/loras/WattEco.js") : null;
 ...
 const loras = (nb: number) =>
    ...
    const creatResultWulti = (nb: number[]) => `'{"value": [${nb}],"valueskeys": {"soil moisture": ${nb[0]},"soil temperature": ${nb[1]},"battery voltage": ${nb[2]}}}'`;
