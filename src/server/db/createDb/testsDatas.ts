...
const numberStr = [
  ...
  const datas = [
    `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (1, 2, '2016-11-18T06:15:15.790Z','2016-11-18T06:15:15.790Z', '2016-11-18T18:30:30.790Z', ${creatResult(
      17.5
    )}) RETURNING *)SELECT * FROM observation;`,
    `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (2, 1, '2016-11-18T03:15:15.790Z','2016-11-18T03:15:15.790Z', '2016-11-18T15:30:30.790Z', ${creatResult(
      11.666666666666666
    )}) RETURNING *)SELECT * FROM observation;`,
    `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (3, 3, '2016-11-18T01:15:15.790Z','2016-11-18T01:15:15.790Z', '2016-11-18T11:30:30.790Z', ${creatResult(
      8.75
    )}) RETURNING *)SELECT * FROM observation;`,
    `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (4, 1, '2016-11-18T08:15:15.790Z','2016-11-18T08:15:15.790Z', '2016-11-18T15:30:30.790Z', ${creatResult(
      17.5
    )}) RETURNING *)SELECT * FROM observation;`,
    `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (1, 4, '2016-11-18T02:15:15.790Z','2016-11-18T02:15:15.790Z', '2016-11-18T15:30:30.790Z', ${creatResult(
      11.666666666666666
    )}) RETURNING *)SELECT * FROM observation;`,
    `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (3, 4, '2016-11-18T05:15:15.790Z','2016-11-18T05:15:15.790Z', '2016-11-18T16:30:30.790Z', ${creatResult(
      8.75
    )}) RETURNING *)SELECT * FROM observation;`,
    `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (2, 2, '2016-11-18T02:15:15.790Z','2016-11-18T02:15:15.790Z', '2016-11-18T18:30:30.790Z', ${creatResult(
      17.5
    )}) RETURNING *)SELECT * FROM observation;`,
    `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (10, 4, '2016-11-18T02:15:15.790Z', '2016-11-18T02:15:15.790Z', '2016-11-18T17:30:30.790Z', ${creatResult(
      45
    )}) RETURNING *)SELECT * FROM observation;`,
    `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (10, 1, '2016-11-18T07:15:15.790Z', '2016-11-18T07:15:15.790Z', '2016-11-18T18:30:30.790Z', ${creatResult(
      45
    )}) RETURNING *)SELECT * FROM observation;`,
    `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (10, 2, '2016-11-18T02:15:15.790Z', '2016-11-18T02:15:15.790Z', '2016-11-18T18:30:30.790Z', ${creatResult(
      45
    )}) RETURNING *)SELECT * FROM observation;`,
    `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 2), 2) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 2), 2) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T01:15:15.790Z', '2016-11-18T12:30:30.790Z', ${creatResultWulti(
      [35, 35, 35]
    )})RETURNING *)SELECT * FROM observation;`,
    `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 2), 2) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 2), 2) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T04:15:15.790Z', '2016-11-18T14:30:30.790Z', ${creatResultWulti(
      [17.5, 35, 17.5]
    )})RETURNING *)SELECT * FROM observation;`,
    `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 4), 4) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 1), 1) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T03:15:15.790Z', '2016-11-18T15:30:30.790Z', ${creatResultWulti(
      [8.75, 17.5, 8.75]
    )})RETURNING *)SELECT * FROM observation;`,
    `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 3), 3) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 4), 4) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T06:15:15.790Z', '2016-11-18T11:30:30.790Z', ${creatResultWulti(
      [8.75, 11.666666666666666, 17.5]
    )})RETURNING *)SELECT * FROM observation;`,
    `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 1), 1) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 1), 1) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T06:15:15.790Z', '2016-11-18T12:30:30.790Z', ${creatResultWulti(
      [17.5, 17.5, 35]
    )})RETURNING *)SELECT * FROM observation;`,
    `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 3), 3) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 1), 1) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T08:15:15.790Z', '2016-11-18T14:30:30.790Z', ${creatResultWulti(
      [35, 17.5, 11.666666666666666]
    )})RETURNING *)SELECT * FROM observation;`,
    `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 2), 2) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 4), 4) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T03:15:15.790Z', '2016-11-18T12:30:30.790Z', ${creatResultWulti(
      [11.666666666666666, 17.5, 11.666666666666666]
    )})RETURNING *)SELECT * FROM observation;`,
    `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 3), 3) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 10), 10) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T05:15:15.790Z', '2016-11-18T13:30:30.790Z', ${creatResultWulti(
      [45, 50, 55]
    )})RETURNING *)SELECT * FROM observation;`,
    `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 4), 4) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 10), 10) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T02:15:15.790Z', '2016-11-18T15:30:30.790Z', ${creatResultWulti(
      [45, 50, 55]
    )})RETURNING *)SELECT * FROM observation;`,
    `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 1), 1) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 10), 10) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T07:15:15.790Z', '2016-11-18T17:30:30.790Z', ${creatResultWulti(
      [45, 50, 55]
    )})RETURNING *)SELECT * FROM observation;`,
