...
const rhf1s001 = process.env.NODE_ENV === "test" ? require("../../../../sandbox/loras/RHF1S001.js") : null;
const senscap = process.env.NODE_ENV === "test" ? require("../../../../sandbox/loras/Sensecap.js") : null;
const wattEco = process.env.NODE_ENV === "test" ? require("../../../../sandbox/loras/WattEco.js") : null;
 ...
 const datas = [
     `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (1, 2, '2016-11-18T06:15:15.790Z','2016-11-18T06:15:15.790Z', '2016-11-18T18:30:30.790Z', ${creatResult(17.5)}) RETURNING *)SELECT * FROM observation;`,
     `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (2, 1, '2016-11-18T03:15:15.790Z','2016-11-18T03:15:15.790Z', '2016-11-18T15:30:30.790Z', ${creatResult(11.666666666666666)}) RETURNING *)SELECT * FROM observation;`,
     `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (3, 3, '2016-11-18T01:15:15.790Z','2016-11-18T01:15:15.790Z', '2016-11-18T11:30:30.790Z', ${creatResult(8.75)}) RETURNING *)SELECT * FROM observation;`,
     `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (4, 1, '2016-11-18T08:15:15.790Z','2016-11-18T08:15:15.790Z', '2016-11-18T15:30:30.790Z', ${creatResult(17.5)}) RETURNING *)SELECT * FROM observation;`,
     `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (1, 4, '2016-11-18T02:15:15.790Z','2016-11-18T02:15:15.790Z', '2016-11-18T15:30:30.790Z', ${creatResult(11.666666666666666)}) RETURNING *)SELECT * FROM observation;`,
     `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (3, 4, '2016-11-18T05:15:15.790Z','2016-11-18T05:15:15.790Z', '2016-11-18T16:30:30.790Z', ${creatResult(8.75)}) RETURNING *)SELECT * FROM observation;`,
     `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (2, 2, '2016-11-18T02:15:15.790Z','2016-11-18T02:15:15.790Z', '2016-11-18T18:30:30.790Z', ${creatResult(17.5)}) RETURNING *)SELECT * FROM observation;`,
     `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (10, 4, '2016-11-18T02:15:15.790Z', '2016-11-18T02:15:15.790Z', '2016-11-18T17:30:30.790Z', ${creatResult(45)}) RETURNING *)SELECT * FROM observation;`,
     `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (10, 1, '2016-11-18T07:15:15.790Z', '2016-11-18T07:15:15.790Z', '2016-11-18T18:30:30.790Z', ${creatResult(45)}) RETURNING *)SELECT * FROM observation;`,
     `WITH observation AS (INSERT INTO "observation" ("datastream_id", "featureofinterest_id", "phenomenonTime", "resultTime", "validTime", "result") values (10, 2, '2016-11-18T02:15:15.790Z', '2016-11-18T02:15:15.790Z', '2016-11-18T18:30:30.790Z', ${creatResult(45)}) RETURNING *)SELECT * FROM observation;`,
     `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 2), 2) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 2), 2) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T01:15:15.790Z', '2016-11-18T12:30:30.790Z', '{"value": {"soil moisture": 35,"soil temperature": 35,"battery voltage": 35}}')RETURNING *)SELECT * FROM observation;`,
     `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 2), 2) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 2), 2) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T04:15:15.790Z', '2016-11-18T14:30:30.790Z', '{"value": {"soil moisture": 17.5,"soil temperature": 35,"battery voltage": 17.5}}')RETURNING *)SELECT * FROM observation;`,
     `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 4), 4) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 1), 1) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T03:15:15.790Z', '2016-11-18T15:30:30.790Z', '{"value": {"soil moisture": 8.75,"soil temperature": 17.5,"battery voltage": 8.75}}')RETURNING *)SELECT * FROM observation;`,
     `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 3), 3) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 4), 4) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T06:15:15.790Z', '2016-11-18T11:30:30.790Z', '{"value": {"soil moisture": 8.75,"soil temperature": 11.666666666666666,"battery voltage": 17.5}}')RETURNING *)SELECT * FROM observation;`,
     `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 1), 1) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 1), 1) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T06:15:15.790Z', '2016-11-18T12:30:30.790Z', '{"value": {"soil moisture": 17.5,"soil temperature": 35,"battery voltage": 35}}')RETURNING *)SELECT * FROM observation;`,
     `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 3), 3) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 1), 1) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T08:15:15.790Z', '2016-11-18T14:30:30.790Z', '{"value": {"soil moisture": 35,"soil temperature": 17.5,"battery voltage": 11.666666666666666}}')RETURNING *)SELECT * FROM observation;`,
     `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 2), 2) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 4), 4) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T03:15:15.790Z', '2016-11-18T12:30:30.790Z', '{"value": {"soil moisture": 11.666666666666666,"soil temperature": 17.5,"battery voltage": 11.666666666666666}}')RETURNING *)SELECT * FROM observation;`,
     `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 3), 3) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 10), 10) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T05:15:15.790Z', '2016-11-18T13:30:30.790Z', '{"value": {"soil moisture": 45,"soil temperature": 50,"battery voltage": 55}}')RETURNING *)SELECT * FROM observation;`,
     `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 4), 4) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 10), 10) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T02:15:15.790Z', '2016-11-18T15:30:30.790Z', '{"value": {"soil moisture": 45,"soil temperature": 50,"battery voltage": 55}}')RETURNING *)SELECT * FROM observation;`,
     `WITH "log_request" as (select srid FROM "spatial_ref_sys" LIMIT 1), featureofinterest1 AS (select coalesce((select "id" from "featureofinterest" where "id" = 1), 1) AS id), multidatastream1 AS (select coalesce((select "id" from "multidatastream" where "id" = 10), 10) AS id), observation AS (INSERT INTO "observation" ("featureofinterest_id", "multidatastream_id", "phenomenonTime", "resultTime", "result") values ((select featureofinterest1.id from featureofinterest1), (select multidatastream1.id from multidatastream1), '2016-11-18T07:15:15.790Z', '2016-11-18T17:30:30.790Z', '{"value": {"soil moisture": 45,"soil temperature": 50,"battery voltage": 55}}')RETURNING *)SELECT * FROM observation;`,
 ...
 export const testsDatas = (): string[] => {
     ...
     `WITH decoder AS (INSERT INTO "decoder" (
        ...
        "synonym") VALUES  (
            'Sensecap', 
            'no description', 
            '{"repository": "https://github.com/Seeed-Solution"}',     
            '${senscap}',
            '010610A6580000010710C80000007FF0',
     ...
     `WITH decoder AS (INSERT INTO "decoder" (
        ...
        "code",
         "test") VALUES  (
            ...
            'no description', 
            '${wattEco}',
            '110A000C00553940C39A35') RETURNING *)SELECT * FROM decoder;`,
    ];
    try {
