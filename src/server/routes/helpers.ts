...
export const isAdmin = (ctx: Koa.Context): boolean =>
  ctx._config.name === "admin";
export const isAllowedTo = (ctx: Koa.Context, what: EuserRights): boolean =>
  ctx._user.PDCUAS[what];
