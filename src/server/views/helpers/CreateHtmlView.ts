...
export class CreateHtmlView {
              ...
              <div class="login-wrap">
                <div class="login-html">
                  ...
                  <div class="login-form">
                    <form action="${this.ctx.decodedUrl.linkbase}/${this.ctx.config.apiVersion}/config" method="post">
                  ...
                  <body>
                      <div class="login-wrap">
                        <div class="login-html">
                          ...
                          <div class="login-form">
                            <form action="${this.ctx.decodedUrl.linkbase}/${this.ctx.config.apiVersion}/login" method="post">
                              <div class="sign-in-htm">
                                ...
                                <div class="hr"></div>
                                ${this.addButton(`${this.ctx.decodedUrl.linkbase}/${this.ctx.config.apiVersion}/Query`, "Return to Query")}
                                <div class="foot-lnk">
    ...
    public status = (user: Iuser): string => {  
      const config = serverConfig.getConfigNameFromDatabase(user.database);  
        return `<!DOCTYPE html> <html> ${this.head(
            ...
            { href: this.ctx.decodedUrl.linkbase + `/${this.ctx.config.apiVersion}/Logout`, class: "button-logout", name: "Logout" },
            { href: this.ctx.decodedUrl.linkbase + `/${this.ctx.config.apiVersion}/Query`, class: "button", name: "Query" }
        ])} </div> </div> </body> </html> `;
    };
    ...
    public error = (message: string): string => {
        return `<!DOCTYPE html> <html> ${this.head(
            ...
            this.ctx.decodedUrl.linkbase + `/${this.ctx.config.apiVersion}/Query`
