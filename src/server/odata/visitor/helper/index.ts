...
export const relationsList = (entity: string, list: string[]) => _DBDATAS[entity].relations.filter((rel: string) => list.includes(_DBDATAS[entity].relations[rel].entityName));
