# <a id="start">TEST : 19/02/2024 : 09:19:25</a>[Things](#Things),[Locations](#Locations),[HistoricalLocations](#HistoricalLocations),[Datastreams](#Datastreams),[MultiDatastreams](#MultiDatastreams),[Sensors](#Sensors),[ObservedProperties](#ObservedProperties),[Observations](#Observations),[CreateObservations](#CreateObservations),[Loras](#Loras),[Various](#Various)## <a id="Root">Root</a>           [🚧](#start)   1. {get}  resource path [GET /v1.1/](http://localhost:8029/test/v1.1/) ✔️   2. {get}  resource path [GET /v1.1/](http://localhost:8029/test/v1.1/) ✔️   3. {get} resource result [GET /v1.1/](http://localhost:8029/test/v1.1/) ✔️## <a id="Token">Token</a>           [🚧](#start)   4. {post} login get a new token [GET /v1.1/login](http://localhost:8029/test/v1.1/login) ✔️   5. {post} login Post basic [GET /v1.1/login](http://localhost:8029/test/v1.1/login) ✔️   6. {get} logout logout actual connection. [GET /v1.1/logout](http://localhost:8029/test/v1.1/logout) ✔️## <a id="Things">Things</a>           [🚧](#start)   7. {get} Things Get all [GET /v1.1/Things](http://localhost:8029/test/v1.1/Things) ✔️   8. {get} Things(:id) Get one [GET /v1.1/Things(1)](http://localhost:8029/test/v1.1/Things(1)) ✔️   9. Return error if Things not exist [GET /v1.1/Things(9007199254740991)](http://localhost:8029/test/v1.1/Things(9007199254740991)) ✔️   10. {get} Things(:id) Get only a property [GET /v1.1/Things(1)/name](http://localhost:8029/test/v1.1/Things(1)/name) ✔️   11. Return error if the column does not exist [GET /v1.1/Things(1)/nameNot](http://localhost:8029/test/v1.1/Things(1)/nameNot) ✔️   12. {get} Things(:id) Get only the value of a property [GET /v1.1/Things(1)/name/$value](http://localhost:8029/test/v1.1/Things(1)/name/$value) ✔️   13. {get} Things(:id) Get Select with @iot.id [GET /v1.1/Things?$select=name,description,@iot.id](http://localhost:8029/test/v1.1/Things?$select=name,description,@iot.id) ✔️   14. {get} Return Things Select id [GET /v1.1/Things?$select=name,description,id](http://localhost:8029/test/v1.1/Things?$select=name,description,id) ✔️   15. {get} Things(:id) Get Select with navigation link [GET /v1.1/Things?$select=name,description,Datastreams](http://localhost:8029/test/v1.1/Things?$select=name,description,Datastreams) ✔️   16. {get} Things(:id) Get Subentity Locations [GET /v1.1/Things(6)/Locations](http://localhost:8029/test/v1.1/Things(6)/Locations) ✔️   17. {get} Things(:id) Get Subentity HistoricalLocations [GET /v1.1/Things(6)/HistoricalLocations](http://localhost:8029/test/v1.1/Things(6)/HistoricalLocations) ✔️   18. {get} Things(:id) Get Subentity Datastreams [GET /v1.1/Things(6)/Datastreams](http://localhost:8029/test/v1.1/Things(6)/Datastreams) ✔️   19. {get} Things(:id) Get Subentity MultiDatastreams [GET /v1.1/Things(11)/MultiDatastreams](http://localhost:8029/test/v1.1/Things(11)/MultiDatastreams) ✔️   20. {get} Things(:id) Get Expand Locations [GET /v1.1/Things(6)?$expand=Locations](http://localhost:8029/test/v1.1/Things(6)?$expand=Locations) ✔️   21. {get} Things(:id) Get Expand with Select [GET /v1.1/Things(6)?$expand=Locations($select=location)](http://localhost:8029/test/v1.1/Things(6)?$expand=Locations($select=location)) ✔️   22. {get} Things(:id) Get Expand coma separation [GET /v1.1/Things(6)?$expand=Locations,HistoricalLocations](http://localhost:8029/test/v1.1/Things(6)?$expand=Locations,HistoricalLocations) ✔️   23. {get} Things(:id) Get Expand  slash separation [GET /v1.1/Things(6)?$expand=Locations/HistoricalLocations](http://localhost:8029/test/v1.1/Things(6)?$expand=Locations/HistoricalLocations) ✔️   24. {get} return Things Expand HistoricalLocations [GET /v1.1/Things(6)?$expand=HistoricalLocations](http://localhost:8029/test/v1.1/Things(6)?$expand=HistoricalLocations) ✔️   25. {get} return Things Expand Datastreams [GET /v1.1/Things(6)?$expand=Datastreams](http://localhost:8029/test/v1.1/Things(6)?$expand=Datastreams) ✔️   26. {get} return Things Select with Expand Datastreams [GET /v1.1/Things?$select=name,description&$expand=Datastreams](http://localhost:8029/test/v1.1/Things?$select=name,description&$expand=Datastreams) ✔️   27. {get} return Things Expand MultiDatastreams [GET /v1.1/Things(11)?$expand=MultiDatastreams](http://localhost:8029/test/v1.1/Things(11)?$expand=MultiDatastreams) ✔️   28. {get} Things(:id) Get only references [GET /v1.1/Things/$ref](http://localhost:8029/test/v1.1/Things/$ref) ✔️   29. {get} Things(:id)/entity(:id) Get nested resource path [GET /v1.1/Things(2)/Datastreams(2)](http://localhost:8029/test/v1.1/Things(2)/Datastreams(2)) ✔️   30. {get} Things(:id)/entity(:id) Get filter nested resource path [GET /v1.1/Things?$filter=Datastreams/description eq 'Pressure sensor'](http://localhost:8029/test/v1.1/Things?$filter=Datastreams/description%20eq%20'Pressure%20sensor') ✔️   31. {get} Things(:id)/entity(:id) Get complex filter nested resource path [GET /v1.1/Things?$filter=Datastreams/ObservedProperty/description eq 'Mesure de la profondeur de la nappe'](http://localhost:8029/test/v1.1/Things?$filter=Datastreams/ObservedProperty/description%20eq%20'Mesure%20de%20la%20profondeur%20de%20la%20nappe') ✔️  32. {post} Things Post basic [POST /v1.1/Things](http://localhost:8029/test/v1.1/Things) ✔️
```js
...
```
  ...
  35. {post} Things Post with existing Location [POST /v1.1/Things](http://localhost:8029/test/v1.1/Things) ✔️
```js
...
```
  ...
  39. {patch} Things Patch a Thing [PATCH /v1.1/Things(17)](http://localhost:8029/test/v1.1/Things(17)) ✔️
```js
{ name: 'New SensorWebThing Patch', properties: { organization: 'Mozilla', owner: 'Mozilla' } } 
```

  40. {patch} return Error if the Things not exist [PATCH /v1.1/Things(9007199254740991)](http://localhost:8029/test/v1.1/Things(9007199254740991)) ✔️
```js
{ name: 'New SensorWebThing Patch', properties: { organization: 'Mozilla', owner: 'Mozilla' } } 
```
...
```
  ...
  43. {delete} Things Delete one [DELETE /v1.1/Things(17)](http://localhost:8029/test/v1.1/Things(17)) ✔️  44. {delete} return Error if the Things not exist [DELETE /v1.1/Things(9007199254740991)](http://localhost:8029/test/v1.1/Things(9007199254740991)) ✔️## <a id="Locations">Locations</a>           [🚧](#start)   45. {get} Locations Get all [GET /v1.1/Locations](http://localhost:8029/test/v1.1/Locations) ✔️   46. {get} Locations(:id) Get one [GET /v1.1/Locations(1)](http://localhost:8029/test/v1.1/Locations(1)) ✔️   47. {get} return error if Locations not exist [GET /v1.1/Locations(9007199254740991)](http://localhost:8029/test/v1.1/Locations(9007199254740991)) ✔️   48. {get} Things(:id)/Locations Get from specific Thing [GET /v1.1/Things(6)/Locations](http://localhost:8029/test/v1.1/Things(6)/Locations) ✔️   49. {get} Locations(:id) Get Subentity Things [GET /v1.1/Locations(6)/Things](http://localhost:8029/test/v1.1/Locations(6)/Things) ✔️   50. {get} Locations(:id) Get Subentity HistoricalLocations [GET /v1.1/Locations(6)/HistoricalLocations](http://localhost:8029/test/v1.1/Locations(6)/HistoricalLocations) ✔️   51. {get} return Locations Expand Things [GET /v1.1/Locations(1)?$expand=Things](http://localhost:8029/test/v1.1/Locations(1)?$expand=Things) ✔️   52. {get} return Locations Expand HistoricalLocations [GET /v1.1/Locations(1)?$expand=HistoricalLocations](http://localhost:8029/test/v1.1/Locations(1)?$expand=HistoricalLocations) ✔️  53. {post} Locations Post basic [POST /v1.1/Locations](http://localhost:8029/test/v1.1/Locations) ✔️
```js
...
```
  ...
  55. {post} Locations Post with existing Thing [POST /v1.1/Things(1)/Locations](http://localhost:8029/test/v1.1/Things(1)/Locations) ✔️
```js
...
```
  ...
  56. {patch} Locations Patch one [PATCH /v1.1/Locations(17)](http://localhost:8029/test/v1.1/Locations(17)) ✔️
```js
...
```
  ...
  57. {patch} return Error if the Locations not exist [PATCH /v1.1/Locations(9007199254740991)](http://localhost:8029/test/v1.1/Locations(9007199254740991)) ✔️
```js
{ name: 'My Location has changed', description: 'Inrae - Site De Saint-Gilles', encodingType: 'application/vnd.geo+json', location: { type: 'Point', coordinates: [ 48.14523718972358, -1.8305352019940178, [length]: 2 ] } } 
```

  58. {delete} Locations Delete one [DELETE /v1.1/Locations(17)](http://localhost:8029/test/v1.1/Locations(17)) ✔️  59. {delete} return Error if the Locations not exist [DELETE /v1.1/Locations(9007199254740991)](http://localhost:8029/test/v1.1/Locations(9007199254740991)) ✔️## <a id="HistoricalLocations">HistoricalLocations</a>           [🚧](#start)   60. {get} HistoricalLocations Get all [GET /v1.1/HistoricalLocations](http://localhost:8029/test/v1.1/HistoricalLocations) ✔️   61. {get} HistoricalLocations(:id) Get one [GET /v1.1/HistoricalLocations(1)](http://localhost:8029/test/v1.1/HistoricalLocations(1)) ✔️   62. Return error if HistoricalLocations not exist [GET /v1.1/HistoricalLocations(9007199254740991)](http://localhost:8029/test/v1.1/HistoricalLocations(9007199254740991)) ✔️   63. {get} HistoricalLocations(:id) Get Expand Locations [GET /v1.1/HistoricalLocations(6)?$expand=Locations](http://localhost:8029/test/v1.1/HistoricalLocations(6)?$expand=Locations) ✔️   64. {get} HistoricalLocations(:id) Get Select [GET /v1.1/HistoricalLocations(6)?$select=time](http://localhost:8029/test/v1.1/HistoricalLocations(6)?$select=time) ✔️   65. {get} HistoricalLocations(:id) Get Subentity Things [GET /v1.1/HistoricalLocations(6)/Things](http://localhost:8029/test/v1.1/HistoricalLocations(6)/Things) ✔️   66. {get} HistoricalLocations(:id) Get Subentity Locations [GET /v1.1/HistoricalLocations(6)/Locations](http://localhost:8029/test/v1.1/HistoricalLocations(6)/Locations) ✔️   67. {get} return HistoricalLocations Expand Things [GET /v1.1/HistoricalLocations(1)?$expand=Things](http://localhost:8029/test/v1.1/HistoricalLocations(1)?$expand=Things) ✔️   68. {get} return HistoricalLocations Expand Locations [GET /v1.1/HistoricalLocations(1)?$expand=Locations](http://localhost:8029/test/v1.1/HistoricalLocations(1)?$expand=Locations) ✔️  69. {patch} HistoricalLocations Patch one [PATCH /v1.1/HistoricalLocations(19)](http://localhost:8029/test/v1.1/HistoricalLocations(19)) ✔️
```js
{ time: '2015-02-07T19:22:11.297Z' } 
```

  70. {patch} return Error if the HistoricalLocations not exist [PATCH /v1.1/HistoricalLocations(9007199254740991)](http://localhost:8029/test/v1.1/HistoricalLocations(9007199254740991)) ✔️
```js
{ time: '2015-02-07T19:22:11.297Z' } 
```

  71. {delete} HistoricalLocations Delete one [DELETE /v1.1/HistoricalLocations(19)](http://localhost:8029/test/v1.1/HistoricalLocations(19)) ✔️  72. {delete} return Error if the HistoricalLocations not exist [DELETE /v1.1/HistoricalLocations(9007199254740991)](http://localhost:8029/test/v1.1/HistoricalLocations(9007199254740991)) ✔️## <a id="Datastreams">Datastreams</a>           [🚧](#start)   73. {get} Datastreams Get all [GET /v1.1/Datastreams](http://localhost:8029/test/v1.1/Datastreams) ✔️   74. {get} Datastreams(:id) Get one [GET /v1.1/Datastreams(1)](http://localhost:8029/test/v1.1/Datastreams(1)) ✔️   75. {get} return error if Datastreams not exist [GET /v1.1/Datastreams(9007199254740991)](http://localhost:8029/test/v1.1/Datastreams(9007199254740991)) ✔️   76. {get} Things(6)/Datastreams Get from a specific Thing [GET /v1.1/Things(6)/Datastreams](http://localhost:8029/test/v1.1/Things(6)/Datastreams) ✔️   77. {get} Datastreams(:id) Get Expands [GET /v1.1/Datastreams(9)?$expand=Observations,ObservedProperty](http://localhost:8029/test/v1.1/Datastreams(9)?$expand=Observations,ObservedProperty) ✔️   78. {get} Datastreams(:id) Get All infos [GET /v1.1/Datastreams(9)?$expand=Thing/Locations,Sensor,ObservedProperty](http://localhost:8029/test/v1.1/Datastreams(9)?$expand=Thing/Locations,Sensor,ObservedProperty) ✔️   79. {get} return error if Datastreams Path is invalid [GET /v1.1/Datastreams(2)?$expand=Things/Locations,Sensor,ObservedProperty](http://localhost:8029/test/v1.1/Datastreams(2)?$expand=Things/Locations,Sensor,ObservedProperty) ✔️   80. {get} Datastreams Get From phenomenonTime search [GET /v1.1/Datastreams?$filter=resultTime eq 2023-02-08T16:37:11Z/2023-02-11T09:49:32Z](http://localhost:8029/test/v1.1/Datastreams?$filter=resultTime%20eq%202023-02-08T16:37:11Z/2023-02-11T09:49:32Z) ✔️   81. {get} Datastreams Get From observations filter [GET /v1.1/Datastreams?$filter=Observations/result eq 63.15](http://localhost:8029/test/v1.1/Datastreams?$filter=Observations/result%20eq%2063.15) ✔️   82. {get} Datastreams(:id) Get Subentity Thing [GET /v1.1/Datastreams(2)/Thing](http://localhost:8029/test/v1.1/Datastreams(2)/Thing) ✔️   83. {get} Datastreams(:id) Get Subentity Sensor [GET /v1.1/Datastreams(2)/Sensor](http://localhost:8029/test/v1.1/Datastreams(2)/Sensor) ✔️   84. {get} Datastreams(:id) Get Subentity ObservedProperty [GET /v1.1/Datastreams(2)/ObservedProperty](http://localhost:8029/test/v1.1/Datastreams(2)/ObservedProperty) ✔️   85. {get} Datastreams(:id) Get Subentity Observations [GET /v1.1/Datastreams(1)/Observations](http://localhost:8029/test/v1.1/Datastreams(1)/Observations) ✔️   86. {get} return Datastreams Expand Thing [GET /v1.1/Datastreams(1)?$expand=Thing](http://localhost:8029/test/v1.1/Datastreams(1)?$expand=Thing) ✔️   87. {get} return Datastreams Expand Sensor [GET /v1.1/Datastreams(1)?$expand=Sensor](http://localhost:8029/test/v1.1/Datastreams(1)?$expand=Sensor) ✔️   88. {get} return Datastreams Expand Observations [GET /v1.1/Datastreams(1)?$expand=Observations](http://localhost:8029/test/v1.1/Datastreams(1)?$expand=Observations) ✔️   89. {get} return Datastreams Expand ObservedProperty [GET /v1.1/Datastreams(1)?$expand=ObservedProperty](http://localhost:8029/test/v1.1/Datastreams(1)?$expand=ObservedProperty) ✔️  90. {post} Datastreams Post with existing Thing [POST /v1.1/Datastreams](http://localhost:8029/test/v1.1/Datastreams) ✔️
```js
...
```
  ...
  93. {post} Datastreams Post with a Thing [POST /v1.1/Things(1)/Datastreams](http://localhost:8029/test/v1.1/Things(1)/Datastreams) ✔️
```js
...
```
  ...
  94. {post} return added Datastreams from Thing [POST /v1.1/Things(1)/Datastreams](http://localhost:8029/test/v1.1/Things(1)/Datastreams) ✔️
```js
...
```
  ...
  95. {patch} Datastreams Patch one [PATCH /v1.1/Datastreams(12)](http://localhost:8029/test/v1.1/Datastreams(12)) ✔️
```js
...
```
  ...
  96. {patch} return Error if the Datastreams not exist [PATCH /v1.1/Datastreams(9007199254740991)](http://localhost:8029/test/v1.1/Datastreams(9007199254740991)) ✔️
```js
...
```
  ...
  97. {delete} Datastreams Delete one [DELETE /v1.1/Datastreams(20)](http://localhost:8029/test/v1.1/Datastreams(20)) ✔️  98. {delete} return Error if the Datastreams not exist [DELETE /v1.1/Datastreams(9007199254740991)](http://localhost:8029/test/v1.1/Datastreams(9007199254740991)) ✔️## <a id="MultiDatastreams">MultiDatastreams</a>           [🚧](#start)   99. {get} MultiDatastreams Get all [GET /v1.1/MultiDatastreams](http://localhost:8029/test/v1.1/MultiDatastreams) ✔️   100. {get} MultiDatastreams(:id) Get one [GET /v1.1/MultiDatastreams(1)](http://localhost:8029/test/v1.1/MultiDatastreams(1)) ✔️   101. {get} return error if MultiDatastreams not exist [GET /v1.1/MultiDatastreams(9007199254740991)](http://localhost:8029/test/v1.1/MultiDatastreams(9007199254740991)) ✔️   102. {get} Things(11)/MultiDatastreams(:id) Get from specific Thing [GET /v1.1/Things(11)/MultiDatastreams](http://localhost:8029/test/v1.1/Things(11)/MultiDatastreams) ✔️   103. {get} all MultiDatastreams informations [GET /v1.1/MultiDatastreams(1)?$expand=Thing/Locations/FeatureOfInterest,Sensor,ObservedProperties](http://localhost:8029/test/v1.1/MultiDatastreams(1)?$expand=Thing/Locations/FeatureOfInterest,Sensor,ObservedProperties) ✔️   104. {get} MultiDatastreams Get From phenomenonTime search [GET /v1.1/MultiDatastreams?$filter=phenomenonTime eq 2023-03-01T10:49:32Z/2023-03-12T21:49:32Z](http://localhost:8029/test/v1.1/MultiDatastreams?$filter=phenomenonTime%20eq%202023-03-01T10:49:32Z/2023-03-12T21:49:32Z) ✔️   105. {get} MultiDatastreams(:id) Get Subentity Thing [GET /v1.1/MultiDatastreams(6)/Thing](http://localhost:8029/test/v1.1/MultiDatastreams(6)/Thing) ✔️   106. {get} MultiDatastreams(:id) Get Subentity Sensor [GET /v1.1/MultiDatastreams(6)/Sensor](http://localhost:8029/test/v1.1/MultiDatastreams(6)/Sensor) ✔️   107. {get} MultiDatastreams(:id) Get Subentity ObservedProperties [GET /v1.1/MultiDatastreams(6)/ObservedProperties](http://localhost:8029/test/v1.1/MultiDatastreams(6)/ObservedProperties) ✔️   108. {get} MultiDatastreams(:id) Get Subentity Observations [GET /v1.1/MultiDatastreams(6)/Observations](http://localhost:8029/test/v1.1/MultiDatastreams(6)/Observations) ✔️   109. {get} return MultiDatastreams Expand Thing [GET /v1.1/MultiDatastreams(1)?$expand=Thing](http://localhost:8029/test/v1.1/MultiDatastreams(1)?$expand=Thing) ✔️   110. {get} return MultiDatastreams Expand Sensor [GET /v1.1/MultiDatastreams(1)?$expand=Sensor](http://localhost:8029/test/v1.1/MultiDatastreams(1)?$expand=Sensor) ✔️   111. {get} return MultiDatastreams Expand Observations [GET /v1.1/MultiDatastreams(1)?$expand=Observations](http://localhost:8029/test/v1.1/MultiDatastreams(1)?$expand=Observations) ✔️   112. {get} return MultiDatastreams Expand ObservedProperties [GET /v1.1/MultiDatastreams(1)?$expand=ObservedProperties](http://localhost:8029/test/v1.1/MultiDatastreams(1)?$expand=ObservedProperties) ✔️  113. {post} MultiDatastreams Post with existing Thing And Sensor [POST /v1.1/MultiDatastreams](http://localhost:8029/test/v1.1/MultiDatastreams) ✔️
```js
...
```
  ...
  117. {post} MultiDatastreams return Error if unitOfMeasurements length not equal multiObservationDataTypes [POST /v1.1/MultiDatastreams](http://localhost:8029/test/v1.1/MultiDatastreams) ✔️
```js
...
```
  ...
  119. {patch} MultiDatastreams Patch one [PATCH /v1.1/MultiDatastreams(12)](http://localhost:8029/test/v1.1/MultiDatastreams(12)) ✔️
```js
{ description: 'Modification of the description' } 
```

  120. {patch} return Error if the MultiDatastreams not exist [PATCH /v1.1/MultiDatastreams(9007199254740991)](http://localhost:8029/test/v1.1/MultiDatastreams(9007199254740991)) ✔️
```js
...
```
  ...
  121. {delete} MultiDatastreams Delete one [DELETE /v1.1/MultiDatastreams(12)](http://localhost:8029/test/v1.1/MultiDatastreams(12)) ✔️  122. {delete} return Error if the MultiDatastreams not exist [DELETE /v1.1/MultiDatastreams(9007199254740991)](http://localhost:8029/test/v1.1/MultiDatastreams(9007199254740991)) ✔️## <a id="Sensors">Sensors</a>           [🚧](#start)   123. {get} Sensors Get all [GET /v1.1/Sensors](http://localhost:8029/test/v1.1/Sensors) ✔️   124. {get} Sensors(:id) Get one [GET /v1.1/Sensors(1)](http://localhost:8029/test/v1.1/Sensors(1)) ✔️   125. {get} return error if Sensors not exist [GET /v1.1/Sensors(9007199254740991)](http://localhost:8029/test/v1.1/Sensors(9007199254740991)) ✔️   126. {get} Sensors(:id) Get Expands [GET /v1.1/Sensors(1)?$expand=Datastreams](http://localhost:8029/test/v1.1/Sensors(1)?$expand=Datastreams) ✔️   127. {get} Sensors(:id) Get Select [GET /v1.1/Sensors(1)?$select=description](http://localhost:8029/test/v1.1/Sensors(1)?$select=description) ✔️   128. {get} Sensors(:id) Get Subentity Datastreams [GET /v1.1/Sensors(6)/Datastreams](http://localhost:8029/test/v1.1/Sensors(6)/Datastreams) ✔️   129. {get} Sensors(:id) Get Subentity MultiDatastreams [GET /v1.1/Sensors(18)/MultiDatastreams](http://localhost:8029/test/v1.1/Sensors(18)/MultiDatastreams) ✔️   130. {get} return Sensors Expand Datastreams [GET /v1.1/Sensors(1)?$expand=Datastreams](http://localhost:8029/test/v1.1/Sensors(1)?$expand=Datastreams) ✔️   131. {get} return Sensors Expand MultiDatastreams [GET /v1.1/Sensors(1)?$expand=MultiDatastreams](http://localhost:8029/test/v1.1/Sensors(1)?$expand=MultiDatastreams) ✔️  132. {post} Sensors Post basic [POST /v1.1/Sensors](http://localhost:8029/test/v1.1/Sensors) ✔️
```js
...
```
  ...
  134. {patch} Sensors Patch one [PATCH /v1.1/Sensors(25)](http://localhost:8029/test/v1.1/Sensors(25)) ✔️
```js
{ description: 'This is a new PM 2.5 sensor' } 
```

  135. {patch} return Error if the Sensors not exist [PATCH /v1.1/Sensors(9007199254740991)](http://localhost:8029/test/v1.1/Sensors(9007199254740991)) ✔️
```js
{ description: 'This is a new PM 2.5 sensor' } 
```

  136. {delete} Sensors Delete one [DELETE /v1.1/Sensors(25)](http://localhost:8029/test/v1.1/Sensors(25)) ✔️  137. {delete} return Error if the Sensors not exist [DELETE /v1.1/Sensors(9007199254740991)](http://localhost:8029/test/v1.1/Sensors(9007199254740991)) ✔️## <a id="ObservedProperties">ObservedProperties</a>           [🚧](#start)   138. {get} ObservedProperties Get all [GET /v1.1/ObservedProperties](http://localhost:8029/test/v1.1/ObservedProperties) ✔️   139. {get} ObservedProperties(:id) Get one [GET /v1.1/ObservedProperties(2)](http://localhost:8029/test/v1.1/ObservedProperties(2)) ✔️   140. Return error if ObservedProperties not exist [GET /v1.1/ObservedProperties(9007199254740991)](http://localhost:8029/test/v1.1/ObservedProperties(9007199254740991)) ✔️   141. {get} Datastream(10/ObservedProperties Get from a specific Datastream [GET /v1.1/Datastreams(9)/ObservedProperty](http://localhost:8029/test/v1.1/Datastreams(9)/ObservedProperty) ✔️   142. {get} ObservedProperties(:id) Get Expand Datastreams [GET /v1.1/ObservedProperties(1)?$expand=Datastreams](http://localhost:8029/test/v1.1/ObservedProperties(1)?$expand=Datastreams) ✔️   143. {get} ObservedProperties(:id) Get from a Select [GET /v1.1/ObservedProperties(1)?$select=description](http://localhost:8029/test/v1.1/ObservedProperties(1)?$select=description) ✔️  144. {post} ObservedProperties Post basic [POST /v1.1/ObservedProperties](http://localhost:8029/test/v1.1/ObservedProperties) ✔️
```js
...
```
  ...
  146. {patch} ObservedProperties Patch one [PATCH /v1.1/ObservedProperties(31)](http://localhost:8029/test/v1.1/ObservedProperties(31)) ✔️
```js
{ name: 'New PM 2.5 ObservedProperties 25' } 
```

  147. {patch} return Error if the ObservedProperties not exist [PATCH /v1.1/ObservedProperties(9007199254740991)](http://localhost:8029/test/v1.1/ObservedProperties(9007199254740991)) ✔️
```js
{ name: 'New SensorWebThing Patch', properties: { organization: 'Mozilla', owner: 'Mozilla' } } 
```

  148. {delete} ObservedProperties Delete one [DELETE /v1.1/ObservedProperties(31)](http://localhost:8029/test/v1.1/ObservedProperties(31)) ✔️  149. {delete} return Error if the ObservedProperties not exist [DELETE /v1.1/ObservedProperties(9007199254740991)](http://localhost:8029/test/v1.1/ObservedProperties(9007199254740991)) ✔️## <a id="Observations">Observations</a>           [🚧](#start)   150. {get} Observations Get all [GET /v1.1/Observations](http://localhost:8029/test/v1.1/Observations) ✔️   151. {get} Observations(:id) Get one [GET /v1.1/Observations(1)](http://localhost:8029/test/v1.1/Observations(1)) ✔️   152. {get} return error if Observations not exist [GET /v1.1/Observations(9007199254740991)](http://localhost:8029/test/v1.1/Observations(9007199254740991)) ✔️   153. {get} Datastreams(2)/Observations Get all from Datastream [GET /v1.1/Datastreams(2)/Observations](http://localhost:8029/test/v1.1/Datastreams(2)/Observations) ✔️   154. {get} Observations(:id) Get Expands [GET /v1.1/Observations(1)?$expand=Datastream](http://localhost:8029/test/v1.1/Observations(1)?$expand=Datastream) ✔️   155. {get} Observations(:id) Get with Multi Select [GET /v1.1/Observations(1)?$select=phenomenonTime,result](http://localhost:8029/test/v1.1/Observations(1)?$select=phenomenonTime,result) ✔️   156. {get} Observations with Standard Results [GET /v1.1/Observations(11)](http://localhost:8029/test/v1.1/Observations(11)) ✔️   157. {get} Observations with Multi keyValue Results [GET /v1.1/Observations(378)?$valuesKeys=true](http://localhost:8029/test/v1.1/Observations(378)?$valuesKeys=true) ✔️   158. Return error with spliResult on Observation entity Only [GET /v1.1/Observations?$splitResult=ALL](http://localhost:8029/test/v1.1/Observations?$splitResult=ALL) ✔️   159. {get} Get with Split Results [GET /v1.1/MultiDatastreams(1)/Observations?$splitResult=all](http://localhost:8029/test/v1.1/MultiDatastreams(1)/Observations?$splitResult=all) ✔️   160. {get} Get with Split Result Property [GET /v1.1/MultiDatastreams(1)/Observations?$splitResult="Unit one of classic"](http://localhost:8029/test/v1.1/MultiDatastreams(1)/Observations?$splitResult=%22Unit%20one%20of%20classic%22) ✔️  161. {post} Observations Post with existing FOI [POST /v1.1/Observations](http://localhost:8029/test/v1.1/Observations) ✔️
```js
...
```
  ...
  164. {post} Observations Post from Datastream [POST /v1.1/Datastreams(10)/Observations](http://localhost:8029/test/v1.1/Datastreams(10)/Observations) ✔️
```js
...
```
  ...
  166. {post} Observations Post from MultiDatastream [POST /v1.1/MultiDatastreams(2)/Observations](http://localhost:8029/test/v1.1/MultiDatastreams(2)/Observations) ✔️
```js
{
  phenomenonTime: '2017-02-07T18:02:00.000Z',
  resultTime: '2017-02-07T18:02:05.000Z',
...
```
  ...
  168. {post} Observations Post from MultiDatastream [POST /v1.1/MultiDatastreams(2)/Observations](http://localhost:8029/test/v1.1/MultiDatastreams(2)/Observations) ✔️
```js
{
  phenomenonTime: '2017-02-07T18:02:00.000Z',
  resultTime: '2017-02-07T18:02:05.000Z',
...
```
  ...
  169. {patch} Observations Patch a Thing [PATCH /v1.1/Observations(529)](http://localhost:8029/test/v1.1/Observations(529)) ✔️
```js
{ phenomenonTime: '2016-11-18T11:04:15.790Z', resultTime: '2016-11-18T11:04:15.790Z' } 
```

  170. {patch} return Error if the Observations not exist [PATCH /v1.1/Observations(9007199254740991)](http://localhost:8029/test/v1.1/Observations(9007199254740991)) ✔️
```js
...
```
  ...
  172. {delete} Observations Delete one [DELETE /v1.1/Observations(529)](http://localhost:8029/test/v1.1/Observations(529)) ✔️  173. {delete} return Error if the Observations not exist [DELETE /v1.1/Observations(9007199254740991)](http://localhost:8029/test/v1.1/Observations(9007199254740991)) ✔️## <a id="FeaturesOfInterest">FeaturesOfInterest</a>           [🚧](#start)   174. {get} FeaturesOfInterest Get all [GET /v1.1/FeaturesOfInterest](http://localhost:8029/test/v1.1/FeaturesOfInterest) ✔️   175. {get} FeaturesOfInterest(:id) Get one [GET /v1.1/FeaturesOfInterest(1)](http://localhost:8029/test/v1.1/FeaturesOfInterest(1)) ✔️   176. {get} return error if FeaturesOfInterest not exist [GET /v1.1/FeaturesOfInterest(9007199254740991)](http://localhost:8029/test/v1.1/FeaturesOfInterest(9007199254740991)) ✔️   177. {get} FeaturesOfInterest(:id) Get one and expand [GET /v1.1/FeaturesOfInterest(1)?$expand=Observations](http://localhost:8029/test/v1.1/FeaturesOfInterest(1)?$expand=Observations) ✔️   178. {get} FeaturesOfInterest(:id) Get Subentity Observations [GET /v1.1/FeaturesOfInterest(12)/Observations](http://localhost:8029/test/v1.1/FeaturesOfInterest(12)/Observations) ✔️   179. {get} return FeaturesOfInterest Expand Observations [GET /v1.1/FeaturesOfInterest(12)?$expand=Observations](http://localhost:8029/test/v1.1/FeaturesOfInterest(12)?$expand=Observations) ✔️  180. {post} FeaturesOfInterest Post basic [POST /v1.1/FeaturesOfInterest](http://localhost:8029/test/v1.1/FeaturesOfInterest) ✔️
```js
...
```
  ...
  182. {patch} FeaturesOfInterest Patch one [PATCH /v1.1/FeaturesOfInterest(15)](http://localhost:8029/test/v1.1/FeaturesOfInterest(15)) ✔️
```js
{ name: 'My New Name', feature: { type: 'Point', coordinates: [ 48.11829243294942, -1.717928984533772, [length]: 2 ] } } 
```

  183. {patch} return Error if the FeaturesOfInterest not exist [PATCH /v1.1/FeaturesOfInterest(9007199254740991)](http://localhost:8029/test/v1.1/FeaturesOfInterest(9007199254740991)) ✔️
```js
{ name: 'My New Name', feature: { type: 'Point', coordinates: [ -115.06, 55.05, [length]: 2 ] } } 
```

  184. {delete} FeaturesOfInterest Delete one [DELETE /v1.1/FeaturesOfInterest(15)](http://localhost:8029/test/v1.1/FeaturesOfInterest(15)) ✔️  185. {delete} return Error if the FeaturesOfInterest not exist [DELETE /v1.1/FeaturesOfInterest(9007199254740991)](http://localhost:8029/test/v1.1/FeaturesOfInterest(9007199254740991)) ✔️## <a id="CreateObservations">CreateObservations</a>           [🚧](#start)  186. {post} CreateObservations Add datastream [POST /v1.1/CreateObservations](http://localhost:8029/test/v1.1/CreateObservations) ✔️
```js
...
```
  ...
  188. {post} return Error if datastream does not exist [POST /v1.1/CreateObservations](http://localhost:8029/test/v1.1/CreateObservations) ✔️
```js
...
## <a id="Loras">Loras</a>           [🚧](#start)   193. {get} Loras Get all [GET /v1.1/Loras](http://localhost:8029/test/v1.1/Loras) ✔️   194. {get} Loras(:id) Get one [GET /v1.1/Loras(1)](http://localhost:8029/test/v1.1/Loras(1)) ✔️   195. {get} Loras(:deveui) Get one [GET /v1.1/Loras(2CF7F1202520017E)](http://localhost:8029/test/v1.1/Loras(2CF7F1202520017E)) ✔️   196. Return error if Loras not exist [GET /v1.1/Loras(9007199254740991)](http://localhost:8029/test/v1.1/Loras(9007199254740991)) ✔️   197. {get} Loras(:id) Get Subentity Datastream [GET /v1.1/Loras(5)/Datastream](http://localhost:8029/test/v1.1/Loras(5)/Datastream) ✔️   198. {get} Loras(:id) Get Subentity MultiDatastream [GET /v1.1/Loras(4)/MultiDatastream](http://localhost:8029/test/v1.1/Loras(4)/MultiDatastream) ✔️   199. {get} Loras(:id) Get Subentity Decoder [GET /v1.1/Loras(4)/Decoder](http://localhost:8029/test/v1.1/Loras(4)/Decoder) ✔️   200. {get} return Loras Expand Datastream [GET /v1.1/Loras(5)?$expand=Datastream](http://localhost:8029/test/v1.1/Loras(5)?$expand=Datastream) ✔️   201. {get} return Loras Expand MultiDatastream [GET /v1.1/Loras(4)?$expand=MultiDatastream](http://localhost:8029/test/v1.1/Loras(4)?$expand=MultiDatastream) ✔️   202. {get} return Loras Expand Decoder [GET /v1.1/Loras(4)?$expand=Decoder](http://localhost:8029/test/v1.1/Loras(4)?$expand=Decoder) ✔️  203. {post} Loras Post MultiDatastream basic [POST /v1.1/Loras](http://localhost:8029/test/v1.1/Loras) ✔️
```js
...
```
  ...
  207. {post} Loras Post observation payload basic [POST /v1.1/Loras](http://localhost:8029/test/v1.1/Loras) ✔️
```js
...
## <a id="Odatas">Odatas</a>           [🚧](#start)   214. {get} Things(:id) Expand [GET /v1.1/Things(6)?$expand=Datastreams](http://localhost:8029/test/v1.1/Things(6)?$expand=Datastreams) ✔️   215. {get} Things(:id) Expand sub Entity [GET /v1.1/Things(6)?$expand=Datastreams/Sensor](http://localhost:8029/test/v1.1/Things(6)?$expand=Datastreams/Sensor) ✔️   216. {get} things(:id) expand with empty result [GET /v1.1/Things(6)?$expand=MultiDatastreams](http://localhost:8029/test/v1.1/Things(6)?$expand=MultiDatastreams) ✔️   217. {get} things(:id) expand with inner filter [GET /v1.1/Datastreams(2)?$expand=Observations($filter=result eq 240)](http://localhost:8029/test/v1.1/Datastreams(2)?$expand=Observations($filter=result%20eq%20240)) ✔️   218. {get} things(:id) expand with inner select [GET /v1.1/Datastreams?$expand=Observations($select=phenomenonTime,result;$orderby=phenomenonTime desc;$top=10)](http://localhost:8029/test/v1.1/Datastreams?$expand=Observations($select=phenomenonTime,result;$orderby=phenomenonTime%20desc;$top=10)) ✔️   219. {get} Things(:id) Select [GET /v1.1/Things(1)?$select=description](http://localhost:8029/test/v1.1/Things(1)?$select=description) ✔️   220. {get} Things(:id) Select multi [GET /v1.1/Things?$select=name,description](http://localhost:8029/test/v1.1/Things?$select=name,description) ✔️   221. {get} Things OrderBy [GET /v1.1/Things?$orderby=name desc](http://localhost:8029/test/v1.1/Things?$orderby=name%20desc) ✔️   222. {get} Observations Top [GET /v1.1/Observations?$top=5](http://localhost:8029/test/v1.1/Observations?$top=5) ✔️   223. {get} Observations Skip [GET /v1.1/Observations?$skip=500](http://localhost:8029/test/v1.1/Observations?$skip=500) ✔️   224. {get} Observations count [GET /v1.1/Observations?$skip=3&$top=2&$count=true](http://localhost:8029/test/v1.1/Observations?$skip=3&$top=2&$count=true) ✔️   225. {Get} filter Datastreams whose unitOfMeasurement property name = 'Degrees Fahrenheit' [GET /v1.1/Datastreams?$filter=unitOfMeasurement/name eq 'Degrees Fahrenheit'](http://localhost:8029/test/v1.1/Datastreams?$filter=unitOfMeasurement/name%20eq%20'Degrees%20Fahrenheit') ✔️   226. {Get} filter name OR description of thing [GET /v1.1/Things?$filter=name eq 'Climatic chamber' or description eq 'A New SensorWeb thing'](http://localhost:8029/test/v1.1/Things?$filter=name%20eq%20'Climatic%20chamber'%20or%20description%20eq%20'A%20New%20SensorWeb%20thing') ✔️   227. {Get} filter name AND description of thing [GET /v1.1/Things?$filter=name eq 'A classic Thing' and description eq 'Description of A classic Thing'](http://localhost:8029/test/v1.1/Things?$filter=name%20eq%20'A%20classic%20Thing'%20and%20description%20eq%20'Description%20of%20A%20classic%20Thing') ✔️   228. {Get} filter name STARTWITH [GET /v1.1/Things?$filter=startswith(description,'A New')](http://localhost:8029/test/v1.1/Things?$filter=startswith(description,'A%20New')) ✔️   229. {Get} filter name CONTAINS [GET /v1.1/Things?$filter=contains(description,'chamber')](http://localhost:8029/test/v1.1/Things?$filter=contains(description,'chamber')) ✔️   230. {Get} filter date greater Than [GET /v1.1/Observations?$filter=phenomenonTime gt '2023-10-13'](http://localhost:8029/test/v1.1/Observations?$filter=phenomenonTime%20gt%20'2023-10-13') ✔️   231. {Get} filter date eq [GET /v1.1/Observations?$filter=result eq '92' and resultTime eq '2017-02-13'](http://localhost:8029/test/v1.1/Observations?$filter=result%20eq%20'92'%20and%20resultTime%20eq%20'2017-02-13') ✔️   232. {get} Thing filter date greater than and less than [GET /v1.1/Observations?$filter=phenomenonTime gt '2021-01-01' and phenomenonTime lt '2021-10-16'](http://localhost:8029/test/v1.1/Observations?$filter=phenomenonTime%20gt%20'2021-01-01'%20and%20phenomenonTime%20lt%20'2021-10-16') ✔️## <a id="Built in filter">Built in filter</a>           [🚧](#start)   233. {get} Observations eq [GET /v1.1/Observations?$filter=result eq 310](http://localhost:8029/test/v1.1/Observations?$filter=result%20eq%20310) ✔️   234. {get} Observations ne [GET /v1.1/Observations?$filter=result ne 45](http://localhost:8029/test/v1.1/Observations?$filter=result%20ne%2045) ✔️   235. {get} Observations gt [GET /v1.1/Observations?$filter=result gt 45](http://localhost:8029/test/v1.1/Observations?$filter=result%20gt%2045) ✔️   236. {get} Odata Built-in operator gt AND lt [GET /v1.1/Observations?$filter=result gt 20 and result lt 22](http://localhost:8029/test/v1.1/Observations?$filter=result%20gt%2020%20and%20result%20lt%2022) ✔️   237. {get} Observations ge [GET /v1.1/Observations?$filter=result ge 45](http://localhost:8029/test/v1.1/Observations?$filter=result%20ge%2045) ✔️   238. {get} Observations lt [GET /v1.1/Observations?$filter=result lt 45](http://localhost:8029/test/v1.1/Observations?$filter=result%20lt%2045) ✔️   239. {get} Observations le [GET /v1.1/Observations?$filter=result le 45](http://localhost:8029/test/v1.1/Observations?$filter=result%20le%2045) ✔️   240. {get} Thing and [GET /v1.1/Things?$filter=name eq 'A classic Thing' and description eq 'Description of A classic Thing'](http://localhost:8029/test/v1.1/Things?$filter=name%20eq%20'A%20classic%20Thing'%20and%20description%20eq%20'Description%20of%20A%20classic%20Thing') ✔️   241. {get} Thing or [GET /v1.1/Things?$filter=name eq 'A classic Thing' or description eq 'Description of Hack $debug=true Thing'](http://localhost:8029/test/v1.1/Things?$filter=name%20eq%20'A%20classic%20Thing'%20or%20description%20eq%20'Description%20of%20Hack%20$debug=true%20Thing') ✔️## <a id="Built in Functions">Built in Functions</a>           [🚧](#start)   242. {get} Things(:id) substringof [GET /v1.1/Things?$filter=substringof('description', 'chamber') eq true](http://localhost:8029/test/v1.1/Things?$filter=substringof('description',%20'chamber')%20eq%20true) ✔️   243. {get} substringof('name', 'with') [GET /v1.1/Things?$filter=substringof('name', 'with')](http://localhost:8029/test/v1.1/Things?$filter=substringof('name',%20'with')) ✔️   244. {get} Things(:id) endwith [GET /v1.1/Things?$filter=endswith('name', 'Thing') eq true](http://localhost:8029/test/v1.1/Things?$filter=endswith('name',%20'Thing')%20eq%20true) ✔️   245. {get} endwith('description', 'one') [GET /v1.1/Things?$filter=endswith('description', 'Thing')](http://localhost:8029/test/v1.1/Things?$filter=endswith('description',%20'Thing')) ✔️   246. {get} Things(:id) startswith [GET /v1.1/Sensors?$filter=startswith('name', 'Hack') eq true](http://localhost:8029/test/v1.1/Sensors?$filter=startswith('name',%20'Hack')%20eq%20true) ✔️   247. {get} endwith(description, 'one') [GET /v1.1/Datastreams?$filter=startswith('name', 'Outlet')](http://localhost:8029/test/v1.1/Datastreams?$filter=startswith('name',%20'Outlet')) ✔️   248. {get} Things(:id) Length [GET /v1.1/Things?$filter=length(description) le 25](http://localhost:8029/test/v1.1/Things?$filter=length(description)%20le%2025) ✔️   249. {get} indexof [GET /v1.1/Things?$filter=indexof('name', 'Piezo') eq 1](http://localhost:8029/test/v1.1/Things?$filter=indexof('name',%20'Piezo')%20eq%201) ✔️   250. {get} Things substring(str, nb) [GET /v1.1/Things?$filter=substring('name', 1) eq 'hing with new Location test'](http://localhost:8029/test/v1.1/Things?$filter=substring('name',%201)%20eq%20'hing%20with%20new%20Location%20test') ✔️   251. {get} Things substring(str, index, nb) [GET /v1.1/Things?$filter=substring('description', 10, 6) eq 'outlet'](http://localhost:8029/test/v1.1/Things?$filter=substring('description',%2010,%206)%20eq%20'outlet') ✔️   252. {get} Things toLower [GET /v1.1/Things?$filter=tolower('name') eq 'piezo f5b'](http://localhost:8029/test/v1.1/Things?$filter=tolower('name')%20eq%20'piezo%20f5b') ✔️   253. {get} Things toUpper [GET /v1.1/Things?$filter=toupper('name') eq 'PIEZOMETER F4'](http://localhost:8029/test/v1.1/Things?$filter=toupper('name')%20eq%20'PIEZOMETER%20F4') ✔️   254. {get} Things trim [GET /v1.1/Things?$filter=trim('name') eq 'Piezo F5b'](http://localhost:8029/test/v1.1/Things?$filter=trim('name')%20eq%20'Piezo%20F5b') ✔️   255. {get} Things concat [GET /v1.1/Things?$filter=concat('name', 'test') eq 'Piezometer F4test'](http://localhost:8029/test/v1.1/Things?$filter=concat('name',%20'test')%20eq%20'Piezometer%20F4test') ✔️## <a id="Built in Dates">Built in Dates</a>           [🚧](#start)   256. {get} Observations Year [GET /v1.1/Observations?$filter=resultTime eq 2017-01-13](http://localhost:8029/test/v1.1/Observations?$filter=resultTime%20eq%202017-01-13) ✔️   257. {get} search by resultTime eq 01-13-2017 [GET /v1.1/Observations?$filter=resultTime eq '13-01-2017'](http://localhost:8029/test/v1.1/Observations?$filter=resultTime%20eq%20'13-01-2017') ✔️   258. {get} search by resultTime gt 13-01-2017 [GET /v1.1/Observations?$filter=resultTime gt '13-01-2017'](http://localhost:8029/test/v1.1/Observations?$filter=resultTime%20gt%20'13-01-2017') ✔️   259. {get} search by resultTime lt 15-10-2021 [GET /v1.1/Observations?$filter=resultTime lt '15-10-2021'](http://localhost:8029/test/v1.1/Observations?$filter=resultTime%20lt%20'15-10-2021') ✔️   260. {get} Observations Year [GET /v1.1/Observations?$filter=year(resultTime) eq 2017](http://localhost:8029/test/v1.1/Observations?$filter=year(resultTime)%20eq%202017) ✔️   261. {get} Observations Month [GET /v1.1/Observations?$filter=month(resultTime) eq 10](http://localhost:8029/test/v1.1/Observations?$filter=month(resultTime)%20eq%2010) ✔️   262. {get} Observations Day [GET /v1.1/Observations?$filter=day(resultTime) eq 11](http://localhost:8029/test/v1.1/Observations?$filter=day(resultTime)%20eq%2011) ✔️   263. {get} Observations Hour [GET /v1.1/Observations?$filter=hour(resultTime) eq 12](http://localhost:8029/test/v1.1/Observations?$filter=hour(resultTime)%20eq%2012) ✔️   264. {get} Observations minute [GET /v1.1/Observations?$filter=minute(resultTime) eq 50](http://localhost:8029/test/v1.1/Observations?$filter=minute(resultTime)%20eq%2050) ✔️   265. {get} Observations second [GET /v1.1/Observations?$filter=second(resultTime) ge 40](http://localhost:8029/test/v1.1/Observations?$filter=second(resultTime)%20ge%2040) ✔️   266. {get} Observations date [GET /v1.1/Observations?$filter=date(resultTime) eq date(phenomenonTime)](http://localhost:8029/test/v1.1/Observations?$filter=date(resultTime)%20eq%20date(phenomenonTime)) ✔️   267. {get} Observations time [GET /v1.1/Observations?$filter=time(resultTime) ne time(phenomenonTime)](http://localhost:8029/test/v1.1/Observations?$filter=time(resultTime)%20ne%20time(phenomenonTime)) ✔️   268. {get} Observations Now() [GET /v1.1/Observations?$filter=resultTime le now()](http://localhost:8029/test/v1.1/Observations?$filter=resultTime%20le%20now()) ✔️## <a id="Built in Maths">Built in Maths</a>           [🚧](#start)   269. {get} Observations Round [GET /v1.1/Observations?$filter=round(result) eq 63](http://localhost:8029/test/v1.1/Observations?$filter=round(result)%20eq%2063) ✔️   270. {get} Observations Floor [GET /v1.1/Observations?$filter=floor(result) eq 63](http://localhost:8029/test/v1.1/Observations?$filter=floor(result)%20eq%2063) ✔️   271. {get} Observations Ceiling [GET /v1.1/Observations?$filter=ceiling(result) eq 63](http://localhost:8029/test/v1.1/Observations?$filter=ceiling(result)%20eq%2063) ✔️## <a id="Built in Miscs">Built in Miscs</a>           [🚧](#start)   272. {get} Observations Interval [GET /v1.1/Datastreams(3)/Observations?$interval=1 hour](http://localhost:8029/test/v1.1/Datastreams(3)/Observations?$interval=1%20hour) ✔️   273. {get} interval(15 min) [GET /v1.1/Datastreams(3)/Observations?$interval=15 min](http://localhost:8029/test/v1.1/Datastreams(3)/Observations?$interval=15%20min) ✔️   274. {get} interval(1 min) [GET /v1.1/Datastreams(3)/Observations?$interval=1 min](http://localhost:8029/test/v1.1/Datastreams(3)/Observations?$interval=1%20min) ✔️   275. {get} interval(1 day) [GET /v1.1/Datastreams(4)/Observations?$interval=1 day](http://localhost:8029/test/v1.1/Datastreams(4)/Observations?$interval=1%20day) ✔️## <a id="Import">Import</a>           [🚧](#start)  276. {post} CreateObservations with simple csv attached file [POST /v1.1/CreateObservations](http://localhost:8029/test/v1.1/CreateObservations) ✔️
...
## <a id="Various">Various</a>           [🚧](#start)   280. result => 1 :  [GET /test/v1.1/Things?$filter=Datastreams/ObservedProperty/description eq 'Description of A classic Observed Property'](http://localhost:8029/test/test/v1.1/Things?$filter=Datastreams/ObservedProperty/description%20eq%20'Description%20of%20A%20classic%20Observed%20Property') ✔️   281. result => 6 :  [GET /test/v1.1/Observations?$filter=phenomenonTime gt 2023-10-13T06:37:13+02:00](http://localhost:8029/test/test/v1.1/Observations?$filter=phenomenonTime%20gt%202023-10-13T06:37:13+02:00) ✔️   282. result => 1 :  [GET /test/v1.1/Things?$filter=Datastreams/unitOfMeasurement/name eq 'Pression'](http://localhost:8029/test/test/v1.1/Things?$filter=Datastreams/unitOfMeasurement/name%20eq%20'Pression') ✔️   283. result => 1 :  [GET /test/v1.1/Things?$filter=Datastreams/unitOfMeasurement/name eq 'PM 2.5 Particulates (ug/m3)'](http://localhost:8029/test/test/v1.1/Things?$filter=Datastreams/unitOfMeasurement/name%20eq%20'PM%202.5%20Particulates%20(ug/m3)') ✔️   284. result => 28 :  [GET /test/v1.1/Observations?$filter=result gt 290 or result eq 250](http://localhost:8029/test/test/v1.1/Observations?$filter=result%20gt%20290%20or%20result%20eq%20250) ✔️   285. result => 25 :  [GET /test/v1.1/Observations?$filter=length(result) le 2](http://localhost:8029/test/test/v1.1/Observations?$filter=length(result)%20le%202) ✔️